...
public class NachteilTableModel extends AbstractCustomTableModel<Nachteil> {
	private List<Nachteil> data;
	...
	public NachteilTableModel(List<Nachteil> data) {
		this.data = data;
	}
	...
	public Nachteil getRowObject(int row) {
		return data.get(row);
	}
	...
	public void addRow(Nachteil rowData){
		insertRow(getRowCount(), rowData);
	}
	
	public void insertRow(int row, Nachteil rowData){
