...
public class KulturEditFrame extends JFrame {
	public KulturEditFrame(Kultur kultur, JTable kulturTable) {
		...
		AddKultur_TalentPanel talentAP = new AddKultur_TalentPanel(kultur,(kultur.getId()==null?(new HashSet<Kultur_TalentGruppe_Mod>()):DbManager.getCurrentDbManager().getTalentOfKultur(kultur)));
			...
			public void actionPerformed(ActionEvent e) {
				switch(e.getActionCommand()){
					case "new":
						...
						kultur.setKultur_talente(talentAP.getKultur_TalentGruppe_Mods());
						kultur.setKultur_professionen(professionAP.getKultur_Professionen());
						kultur.setSozialstatus_maximum((Integer)somaxSP.getValue());
//						kultur.getKultur_sonderfertigkeiten();
